...
from ...utils import type_sort_signals, sort_signals_by_start_bit, sort_signals_by_start_bit_reversed, \
...
def _dump_signal_groups(database):
    ...
    for message in database.messages:
        ...
        for signal_group in message.signal_groups:
            ...
            signal_group.signal_names = list(
                filter(lambda sig_name: sig_name in all_sig_names, signal_group.signal_names))
            sig_group.append(
